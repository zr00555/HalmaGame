...
The game should have an option to reset the board (restart the game). The game should have a button to close the application.Optionally: Suggest and get instructor approval on a GUI game of your choice.
